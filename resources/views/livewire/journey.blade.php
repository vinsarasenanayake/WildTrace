                ...
                @foreach($milestones as $milestone)
                    @if($loop->odd)
                        <div class="relative flex flex-col md:flex-row items-center justify-between group">
                            <div
                                class="absolute left-[-9px] md:left-1/2 md:-translate-x-[9px] w-4 h-4 rounded-full bg-green-500 border-4 border-white shadow-lg">
                            </div>
                            <div
                                class="md:w-5/12 ml-8 md:ml-0 md:text-right p-6 bg-stone-50 rounded-2xl border border-stone-100 shadow-sm hover:shadow-md transition-all">
                    ...
                    @else
                        ,StartLine:161,TargetContent: <div
                            ...
                            <div class="hidden md:block w-5/12"></div>
                            <div
                                class="md:w-5/12 ml-8 md:ml-0 p-6 bg-stone-50 rounded-2xl border border-stone-100 shadow-sm hover:shadow-md transition-all">
                                <span class="text-green-600 font-bold text-xl">{{ $milestone->year }}</span>
                                <h3 class="text-xl font-serif text-stone-900 mt-1">{{ $milestone->title }}</h3>
                                <p class="text-stone-500 text-sm mt-2">{{ $milestone->description }}</p>
                            </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                @foreach($photographers as $photographer)
                    <div
                        class="relative overflow-hidden rounded-[2rem] bg-stone-900 border border-white/5 shadow-2xl transition-all duration-500 hover:shadow-green-900/10 group">
                        <div class="relative h-[450px] overflow-hidden">
                            ...
                            <div class="absolute top-6 right-6 z-20">
                                <span
                                    class="bg-white/10 backdrop-blur-md border border-white/20 text-white text-[9px] font-black px-3 py-1.5 rounded-full uppercase tracking-widest shadow-lg">{{ $photographer->achievement }}</span>
                            </div>
                        </div>
                        <div class="absolute inset-0 flex flex-col justify-end p-8 z-10">
                            <h3 class="text-white text-2xl font-serif italic mb-1">
                                {{ ucwords(strtolower($photographer->name)) }}
                            </h3>
                            ...
                            <div class="mb-3">
                                <p
                                    class="text-stone-200 text-xs italic leading-relaxed border-l-2 border-green-500/50 pl-4 py-1">
                                    "{{ $photographer->quote }}"
                                </p>
                            </div>

                            <div
                                class="mt-4 flex items-center gap-2 uppercase tracking-[0.3em] text-[9px] font-black text-stone-300">
