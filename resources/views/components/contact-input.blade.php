...
@php
    // Fetch all countries for dial code selection
...
<!--
    ...
    Integrates a country dial code selector with a masked phone number input.
    Features: Reactive z-index stacking to prevent UI overlapping.
-->
<div x-data="{ 
    open: false, 
    selected: '{{ $dialCode }}'
